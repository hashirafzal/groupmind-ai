...
export default function Navbar(): React.JSX.Element {
  ...
  return (
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/5 bg-background/80 backdrop-blur-md">
          ...
          {isLoggedIn ? (
            <>
              {session.user.subscriptionTier !== 'FREE' && (
                <Link
                  href="/discuss/new"
                  className="hidden rounded-lg bg-brand-purple px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-brand-purple/90 sm:block"
                >
                  Start Discussion
                </Link>
              )}
